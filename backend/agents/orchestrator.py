...
class TeacherOrchestrator:
    ...
    def _format_specialist_outputs(self, outputs: Dict[str, Any]) -> str:
        ...
        for agent_name, output in outputs.items():
            ...
            elif isinstance(output, ClarificationOutput):
                lines.append(f"Clarification: {output.clarification}")
                lines.append(f"New Approach: {output.new_approach}")
                lines.append(f"Check Question: {output.check_question}")
